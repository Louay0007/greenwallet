      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          <div className="pulse-chip mx-auto mb-3 sm:mb-4 opacity-0 fade-in-element">
            <span>GreenWallet Features</span>
          </div>
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Smart Technology for <br className="hidden sm:block" />Climate Action
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            AI-powered verification, IoT integration, and gamified rewards make sustainability engaging and rewarding.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Computer vision automatically verifies your eco-actions through photo analysis, ensuring authentic climate impact and preventing fraud."
            index={0}
          />
          <FeatureCard
            ...
            description="Smart recycling bins with weight sensors and QR readers automatically track your recycling and award GreenCoins instantly."
            index={1}
          />
          <FeatureCard
            ...
            title="GreenCoin Rewards"
            description="Earn digital GreenCoins for every eco-action, redeem for discounts, donate to causes, or trade for carbon credits."
            index={2}
          />
          <FeatureCard
            ...
            description="Compete with friends, schools, and neighborhoods in eco-challenges. Leaderboards and team competitions make climate action fun."
            index={3}
          />
          <FeatureCard
            ...
            description="See your climate impact in real-time with live dashboards showing CO2 saved, waste diverted, and community progress."
            index={4}
          />
          <FeatureCard
            ...
            description="Shop sustainable products, find local eco-friendly businesses, and support green initiatives with your earned GreenCoins."
            index={5}
          />
        </div>
      </div>
