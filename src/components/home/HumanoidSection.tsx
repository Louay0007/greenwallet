...
const HumanoidSection = () => {
  ...
  return (
    <div 
      ...
      style={{ height: '300vh' }}
    >
      <section className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-white" id="why-greenwallet">
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Reward real eco‑actions with instant, transparent impact
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="absolute top-4 right-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">
                  <span className="text-sm font-medium">Smart verification</span>
                </div>
              </div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    IoT bins + photo checks = verified recycling, no hassle
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex flex-col sm:flex-row items-center justify-end sm:justify-between">
                <div className="max-w-lg mb-6 sm:mb-0">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Compete, redeem, donate — <span className="text-[#FC4D0A]">for a greener Tunisia</span>
                  </h3>
                </div>
                ...
                <img 
                    ...
                    className="w-auto opacity-90 h-52 sm:h-60 md:h-80 lg:h-96 xl:h-[520px]"
                  />
                </div>
              </div>
            </div>
